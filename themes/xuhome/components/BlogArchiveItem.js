      ...
      <div className='space-y-3 mt-4'>
        {archivePosts?.map(post => (
          <SmartLink key={post.id} href={post.href} className='no-underline group block'>
            <div className='border-2 border-[#0284c7] rounded-sm shadow-[3px_3px_0px_0px_#0284c7] bg-[rgba(250,248,245,0.55)] dark:bg-slate-800 p-3 hover:-translate-y-0.5 hover:shadow-[4px_4px_0px_0px_#0284c7] active:shadow-[1px_1px_0px_0px_#0284c7] transition-all flex items-baseline gap-4'>
