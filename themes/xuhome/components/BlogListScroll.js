  ...
  return (
    <div ref={targetRef}>
      ...
      <div onClick={handleGetMore} className='text-center py-6'>
        <span className='inline-block border-2 border-[#1e3a8a] rounded-sm shadow-[2px_2px_0px_0px_#1e3a8a] bg-[#ffffff] dark:bg-slate-800 px-6 py-2 font-black text-sm text-[#1e3a8a] uppercase tracking-wider hover:bg-[#1d4ed8] hover:text-white active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all cursor-pointer select-none'>
